...
import type { MemberRole } from "@/auth/api";
...
export function TeamPage() {
  ...
  return <PageContainer>
    ...
    <form className="mb-6 flex flex-col gap-3 rounded-xl border border-[#e2e8f0] bg-white p-4 sm:flex-row sm:items-end" onSubmit={(event) => { event.preventDefault(); mutation.mutate({ email, role }); }}>
