...
import { RecordPaymentDto, ReversePaymentDto } from './dto/record-payment.dto.js';
...
export class BillingController {
  ...
  @Post('pricing-plans') @RequirePermissions(PERMISSIONS.BILLING_COLLECT) @ApiInvalidRequest() @ApiCreatedResponse({ schema: schemaRef('PricingPlan') }) createPlan(@Body() input: CreatePricingPlanDto) { return this.billing.createPlan(input); }
  ...
  @Post('invoices') @RequirePermissions(PERMISSIONS.BILLING_COLLECT) @ApiInvalidRequest() @ApiCreatedResponse({ schema: schemaRef('Invoice') }) createInvoice(@Body() input: CreateInvoiceDto) { return this.billing.createInvoice(input); }
  ...
  @Post('invoices/:id/issue') @RequirePermissions(PERMISSIONS.BILLING_COLLECT) @ApiUlidParam() issue(@Param('id') id: string) { return this.billing.issue(id); }
  @Post('invoices/:id/void') @RequirePermissions(PERMISSIONS.BILLING_COLLECT) @ApiUlidParam() void(@Param('id') id: string) { return this.billing.void(id); }
  ...
  @Post('payments/:id/reverse') @RequirePermissions(PERMISSIONS.BILLING_COLLECT) @ApiUlidParam() reversePayment(@Param('id') id: string, @Body() input: ReversePaymentDto) { return this.billing.reversePayment(id, input); }
}
